namespace z88dk_compile_options_helper_beta
{
	partial class quick_start
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(quick_start));
			this.textBox1 = new System.Windows.Forms.TextBox();
			this.panel1 = new System.Windows.Forms.Panel();
			this.classicLibrary = new System.Windows.Forms.RadioButton();
			this.newLibrary = new System.Windows.Forms.RadioButton();
			...
			this.library_sdcc_classic = new System.Windows.Forms.RadioButton();
			this.library_sccZ80_classic = new System.Windows.Forms.RadioButton();
			this.library_sdccIY_reserve_IY = new System.Windows.Forms.RadioButton();
			this.library_sdccIX_reserve_IY = new System.Windows.Forms.RadioButton();
			this.library_sdccIX_no_reserve_IY = new System.Windows.Forms.RadioButton();
			this.library_sccZ80 = new System.Windows.Forms.RadioButton();
			...
			this.panel1.Controls.Add(this.classicLibrary);
			this.panel1.Controls.Add(this.newLibrary);
			...
			// classicLibrary
			// 
			this.classicLibrary.AutoSize = true;
			this.classicLibrary.Location = new System.Drawing.Point(26, 46);
			this.classicLibrary.Name = "classicLibrary";
			this.classicLibrary.Size = new System.Drawing.Size(58, 17);
			this.classicLibrary.TabIndex = 123;
			this.classicLibrary.TabStop = true;
			this.classicLibrary.Text = "Classic";
			this.classicLibrary.UseVisualStyleBackColor = true;
			this.classicLibrary.CheckedChanged += new System.EventHandler(this.classicLibrary_CheckedChanged);
			// 
			// newLibrary
			// 
			this.newLibrary.AutoSize = true;
			this.newLibrary.ForeColor = System.Drawing.SystemColors.ControlText;
			this.newLibrary.Location = new System.Drawing.Point(26, 23);
			this.newLibrary.Name = "newLibrary";
			this.newLibrary.Size = new System.Drawing.Size(47, 17);
			this.newLibrary.TabIndex = 122;
			this.newLibrary.TabStop = true;
			this.newLibrary.Text = "New";
			this.newLibrary.UseVisualStyleBackColor = true;
			this.newLibrary.CheckedChanged += new System.EventHandler(this.newLibrary_CheckedChanged);
			// 
			// button1
			// 
			...
			this.button1.Text = "?";
			this.toolTip1.SetToolTip(this.button1, "Choose your compiler\r\n\r\nChoices \r\nNew Library\r\n\r\nClassic Library");
			...
			this.label3.Text = "Compiler Library";
			// 
			// panel2
			// 
			...
			this.lmzxtinyFloatPoint.Location = new System.Drawing.Point(169, 50);
			...
			this.lmzxFloatPoint.Location = new System.Drawing.Point(169, 27);
			...
			this.panel3.Controls.Add(this.library_sdcc_classic);
			this.panel3.Controls.Add(this.library_sccZ80_classic);
			this.panel3.Controls.Add(this.library_sdccIY_reserve_IY);
			this.panel3.Controls.Add(this.library_sdccIX_reserve_IY);
			this.panel3.Controls.Add(this.library_sdccIX_no_reserve_IY);
			this.panel3.Controls.Add(this.library_sccZ80);
			...
			this.panel3.Size = new System.Drawing.Size(203, 204);
			this.panel3.TabIndex = 115;
			// 
			// library_sdcc_classic
			// 
			this.library_sdcc_classic.AutoSize = true;
			this.library_sdcc_classic.Enabled = false;
			this.library_sdcc_classic.Location = new System.Drawing.Point(26, 174);
			this.library_sdcc_classic.Name = "library_sdcc_classic";
			this.library_sdcc_classic.Size = new System.Drawing.Size(96, 17);
			this.library_sdcc_classic.TabIndex = 136;
			this.library_sdcc_classic.TabStop = true;
			this.library_sdcc_classic.Text = "-compiler=sdcc";
			this.library_sdcc_classic.UseVisualStyleBackColor = true;
			this.library_sdcc_classic.CheckedChanged += new System.EventHandler(this.library_sdcc_classic_CheckedChanged);
			// 
			// library_sccZ80_classic
			// 
			this.library_sccZ80_classic.AutoSize = true;
			this.library_sccZ80_classic.Enabled = false;
			this.library_sccZ80_classic.ForeColor = System.Drawing.SystemColors.ControlText;
			this.library_sccZ80_classic.Location = new System.Drawing.Point(26, 151);
			this.library_sccZ80_classic.Name = "library_sccZ80_classic";
			this.library_sccZ80_classic.Size = new System.Drawing.Size(107, 17);
			this.library_sccZ80_classic.TabIndex = 135;
			this.library_sccZ80_classic.TabStop = true;
			this.library_sccZ80_classic.Text = "-compiler=sccz80";
			this.library_sccZ80_classic.UseVisualStyleBackColor = true;
			this.library_sccZ80_classic.CheckedChanged += new System.EventHandler(this.library_sccZ80_classic_CheckedChanged);
			// 
			// library_sdccIY_reserve_IY
			// 
			this.library_sdccIY_reserve_IY.AutoSize = true;
			this.library_sdccIY_reserve_IY.Enabled = false;
			this.library_sdccIY_reserve_IY.Location = new System.Drawing.Point(26, 99);
			this.library_sdccIY_reserve_IY.Name = "library_sdccIY_reserve_IY";
			this.library_sdccIY_reserve_IY.Size = new System.Drawing.Size(112, 17);
			this.library_sdccIY_reserve_IY.TabIndex = 134;
			this.library_sdccIY_reserve_IY.TabStop = true;
			this.library_sdccIY_reserve_IY.Text = "sdcc IY reserve IY";
			this.library_sdccIY_reserve_IY.UseVisualStyleBackColor = true;
			this.library_sdccIY_reserve_IY.CheckedChanged += new System.EventHandler(this.library_sdccIY_reserve_IY_CheckedChanged);
			// 
			// library_sdccIX_reserve_IY
			// 
			this.library_sdccIX_reserve_IY.AutoSize = true;
			this.library_sdccIX_reserve_IY.Enabled = false;
			this.library_sdccIX_reserve_IY.Location = new System.Drawing.Point(26, 76);
			this.library_sdccIX_reserve_IY.Name = "library_sdccIX_reserve_IY";
			this.library_sdccIX_reserve_IY.Size = new System.Drawing.Size(112, 17);
			this.library_sdccIX_reserve_IY.TabIndex = 133;
			this.library_sdccIX_reserve_IY.TabStop = true;
			this.library_sdccIX_reserve_IY.Text = "sdcc IX reserve IY";
			this.library_sdccIX_reserve_IY.UseVisualStyleBackColor = true;
			this.library_sdccIX_reserve_IY.CheckedChanged += new System.EventHandler(this.library_sdccIX_reserve_IY_CheckedChanged);
			// 
			// library_sdccIX_no_reserve_IY
			// 
			this.library_sdccIX_no_reserve_IY.AutoSize = true;
			this.library_sdccIX_no_reserve_IY.Enabled = false;
			this.library_sdccIX_no_reserve_IY.Location = new System.Drawing.Point(26, 51);
			this.library_sdccIX_no_reserve_IY.Name = "library_sdccIX_no_reserve_IY";
			this.library_sdccIX_no_reserve_IY.Size = new System.Drawing.Size(149, 17);
			this.library_sdccIX_no_reserve_IY.TabIndex = 132;
			this.library_sdccIX_no_reserve_IY.TabStop = true;
			this.library_sdccIX_no_reserve_IY.Text = "sdcc IX Do Not reserve IY";
			this.library_sdccIX_no_reserve_IY.UseVisualStyleBackColor = true;
			this.library_sdccIX_no_reserve_IY.CheckedChanged += new System.EventHandler(this.library_sdccIX_no_reserve_IY_CheckedChanged);
			// 
			// library_sccZ80
			// 
			this.library_sccZ80.AutoSize = true;
			this.library_sccZ80.Enabled = false;
			this.library_sccZ80.Location = new System.Drawing.Point(26, 28);
			this.library_sccZ80.Name = "library_sccZ80";
			this.library_sccZ80.Size = new System.Drawing.Size(88, 17);
			this.library_sccZ80.TabIndex = 131;
			this.library_sccZ80.TabStop = true;
			this.library_sccZ80.Text = "new (sccz80)";
			this.library_sccZ80.UseVisualStyleBackColor = true;
			this.library_sccZ80.CheckedChanged += new System.EventHandler(this.library_sccZ80_CheckedChanged);
			// 
			// button14
			// 
			this.button14.Location = new System.Drawing.Point(173, 125);
			this.button14.Name = "button14";
			this.button14.Size = new System.Drawing.Size(21, 23);
			this.button14.TabIndex = 129;
			this.button14.Text = "?";
			this.toolTip1.SetToolTip(this.button14, "classic library");
			this.button14.UseVisualStyleBackColor = true;
			// 
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(173, 4);
			this.button2.Name = "button2";
			this.button2.Size = new System.Drawing.Size(21, 23);
			this.button2.TabIndex = 122;
			this.button2.Text = "?";
			this.toolTip1.SetToolTip(this.button2, "new library \r\n\r\n");
			...
			this.label6.Text = "Classic Library";
			// 
			// label4
			// 
			...
			this.textBox2.Text = "zcc +zx -lndos -create-app program.c";
			// 
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(15, 56);
			this.textBox3.Name = "textBox3";
			this.textBox3.Size = new System.Drawing.Size(336, 20);
			this.textBox3.TabIndex = 117;
			this.textBox3.Text = "zcc +zx -clib=ansi -lndos -create-app program.c";
			// 
			// label5
			// 
			...
			this.label5.Text = "Common Comple Strings for: ";
			// 
			// panel4
			// 
			...
			this.panel4.Location = new System.Drawing.Point(9, 544);
			this.panel4.Name = "panel4";
			this.panel4.Size = new System.Drawing.Size(421, 89);
			...
			this.panel5.Controls.Add(this.media_device_LP3DOS);
			this.panel5.Controls.Add(this.media_device_DPLUS);
			this.panel5.Controls.Add(this.media_device_LNDOS);
			...
			this.media_device_LP3DOS.Location = new System.Drawing.Point(26, 85);
			...
			this.media_device_LP3DOS.CheckedChanged += new System.EventHandler(this.media_device_LP3DOS_CheckedChanged);
			// 
			// media_device_DPLUS
			// 
			this.media_device_DPLUS.AutoSize = true;
			this.media_device_DPLUS.Enabled = false;
			this.media_device_DPLUS.Location = new System.Drawing.Point(26, 62);
			...
			this.media_device_DPLUS.CheckedChanged += new System.EventHandler(this.media_device_DPLUS_CheckedChanged);
			// 
			// media_device_LNDOS
			// 
			this.media_device_LNDOS.AutoSize = true;
			this.media_device_LNDOS.Enabled = false;
			this.media_device_LNDOS.Location = new System.Drawing.Point(26, 39);
			...
			this.label14.Text = "Mandatory on Classic Library";
			// 
			// label13
			// 
			...
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(185, 3);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(21, 23);
			this.button6.TabIndex = 123;
			this.button6.Text = "?";
			this.toolTip1.SetToolTip(this.button6, "Your C source to be compiled");
			this.button6.UseVisualStyleBackColor = true;
			// 
			// button11
			// 
			this.button11.Location = new System.Drawing.Point(119, 23);
			this.button11.Name = "button11";
			this.button11.Size = new System.Drawing.Size(21, 23);
			this.button11.TabIndex = 123;
			this.button11.Text = "?";
			this.toolTip1.SetToolTip(this.button11, "-o The file name you want to create with the\r\nCreate App option");
			this.button11.UseVisualStyleBackColor = true;
			// 
			// button17
			// 
			this.button17.Location = new System.Drawing.Point(402, 3);
			...
			// button21
			// 
			this.button21.Location = new System.Drawing.Point(407, 7);
        ...
        "t. ");
			...
			this.panel6.Location = new System.Drawing.Point(499, 154);
			this.panel6.Name = "panel6";
			this.panel6.Size = new System.Drawing.Size(430, 84);
			this.panel6.TabIndex = 121;
			// 
			// label15
			// 
			this.label15.AutoSize = true;
			this.label15.Location = new System.Drawing.Point(20, 28);
			this.label15.Name = "label15";
			this.label15.Size = new System.Drawing.Size(89, 13);
			this.label15.TabIndex = 134;
			this.label15.Text = "Output File Name";
			// 
			// textBox5
			// 
			this.textBox5.Location = new System.Drawing.Point(4, 50);
			...
			this.button13.Location = new System.Drawing.Point(363, 47);
			...
			this.checkBox3.Text = "Create App";
			...
			this.button12.Location = new System.Drawing.Point(292, 48);
			...
			this.panel7.Location = new System.Drawing.Point(499, 252);
			this.panel7.Name = "panel7";
			this.panel7.Size = new System.Drawing.Size(430, 114);
			this.panel7.TabIndex = 122;
			// 
			// button15
			// 
			this.button15.Enabled = false;
			this.button15.Location = new System.Drawing.Point(363, 74);
			...
			this.button16.Location = new System.Drawing.Point(292, 73);
			this.button16.Name = "button16";
			this.button16.Size = new System.Drawing.Size(59, 23);
			...
			this.label18.Text = "Manual Entry";
			// 
			// textBox6
			// 
			this.textBox6.Enabled = false;
			this.textBox6.Location = new System.Drawing.Point(4, 77);
			...
			this.label7.Text = "File to Compile";
			// 
			// button9
			// 
			this.button9.Enabled = false;
			this.button9.Location = new System.Drawing.Point(363, 31);
			...
			this.button8.Location = new System.Drawing.Point(292, 30);
			...
			// button10
			// 
			this.button10.Location = new System.Drawing.Point(471, 610);
			this.button10.Name = "button10";
			this.button10.Size = new System.Drawing.Size(75, 23);
			this.button10.TabIndex = 123;
			this.button10.Text = "Start Over";
			...
			this.label2.Text = "Your Compile String";
			// 
			// label8
			// 
			...
			this.label17.Location = new System.Drawing.Point(477, 55);
			...
			this.panel8.Controls.Add(this.reset_zorg);
			...
			this.panel8.Location = new System.Drawing.Point(499, 12);
			...
			this.label25.Location = new System.Drawing.Point(45, 91);
			this.label25.Name = "label25";
			this.label25.Size = new System.Drawing.Size(69, 13);
			this.label25.TabIndex = 149;
			this.label25.Text = "Manual Entry";
			// 
			// button18
			// 
			this.button18.Enabled = false;
			this.button18.Location = new System.Drawing.Point(121, 105);
			...
			this.textBox7.Location = new System.Drawing.Point(15, 107);
			...
			this.textBox8.Location = new System.Drawing.Point(297, 107);
			...
			this.label19.Text = "32768";
			// 
			// label20
			// 
			this.label20.AutoSize = true;
			this.label20.Location = new System.Drawing.Point(324, 88);
			this.label20.Name = "label20";
			this.label20.Size = new System.Drawing.Size(37, 13);
			this.label20.TabIndex = 144;
			this.label20.Text = "65535";
			// 
			// label21
			// 
			...
			this.label23.Text = "ZORG";
			// 
			// label24
			// 
			this.label24.AutoSize = true;
			this.label24.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.label24.Location = new System.Drawing.Point(477, 180);
			...
			this.panel10.Location = new System.Drawing.Point(34, 318);
			...
			this.f_signed_char.Enabled = false;
			...
			this.label26.Location = new System.Drawing.Point(477, 286);
			...
			this.Name = "quick_start";
			this.Text = "quick_start";
			this.Load += new System.EventHandler(this.quick_start_Load);
		...
		private System.Windows.Forms.RadioButton classicLibrary;
		private System.Windows.Forms.RadioButton newLibrary;
		private System.Windows.Forms.RadioButton library_sccZ80;
		private System.Windows.Forms.RadioButton library_sdccIX_no_reserve_IY;
		private System.Windows.Forms.RadioButton library_sdccIX_reserve_IY;
		private System.Windows.Forms.RadioButton library_sdccIY_reserve_IY;
		private System.Windows.Forms.RadioButton library_sccZ80_classic;
		private System.Windows.Forms.RadioButton library_sdcc_classic;
